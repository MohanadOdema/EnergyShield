...
4. At least 78GB of free disk space on the filesystem where Docker stores images (the filesystem containing `/var/lib/docker` [by default](https://docs.docker.com/config/daemon/#daemon-data-directory))
