...
recorder_path = parent_directory + "/EnergyShield/models/casc_agent2/experiments/obs_4_route_short/80p_ResNet152_local_cont/PX2_100_Safety_False_noise_False/logs/test.log"
...
def main():
    ...
    try:
        ...
        print("Recording on file: %s" % client.start_recorder(recorder_path))
