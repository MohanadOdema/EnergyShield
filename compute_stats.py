...
csv_file_path = os.path.join("./models", params['model_name'], "experiments", "obs_"+str(params['len_obs'])+"_route_short", "80p_ResNet152_"+str(params['offload_policy'])+"_"+sup_string, 
