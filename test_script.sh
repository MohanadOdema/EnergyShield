...
python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 5 --obs_start_idx 15 --num_episodes 30

python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 5 --obs_start_idx 15 --num_episodes 30 -gaussian

python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 5 --obs_start_idx 15 --num_episodes 30 -safety_filter

python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 5 --obs_start_idx 15 --num_episodes 30 -gaussian -safety_filter
