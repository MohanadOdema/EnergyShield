...
# python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 100 -safety_filter

# python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 100 -gaussian -safety_filter

# python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 100

# python run.py --model_name casc_agent1 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 100 -gaussian
...
# python run.py --model_name casc_agent3 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 30 -safety_filter

# python run.py --model_name casc_agent3 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 30 -gaussian -safety_filter

# python run.py --model_name casc_agent3 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 30

# python run.py --model_name casc_agent3 -obstacle -test --offload_policy local --len_obs 4 --obs_start_idx 20 --num_episodes 30 -gaussian
